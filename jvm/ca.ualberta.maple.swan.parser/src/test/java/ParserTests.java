...
public class ParserTests {
    ...
    void testModuleParsing() throws Error, URISyntaxException, IOException {
        ...
        for (File sil : silFiles) {
            ...
            /*FileWriter expectedFile = new FileWriter(sil.getPath() + ".expected");
            FileWriter actualFile = new FileWriter(sil.getPath() + ".actual");
            expectedFile.write(expected);
            expectedFile.close();
            actualFile.write(result);
            actualFile.close();*/
    ...
    @Test
    @Disabled
    void testModuleParsingDontCompare() throws Error, URISyntaxException {
        System.out.println("Testing modules");
        File fileDir = new File(getClass().getClassLoader()
