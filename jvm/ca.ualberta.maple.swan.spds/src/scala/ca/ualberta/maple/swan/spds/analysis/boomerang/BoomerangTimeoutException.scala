...
class BoomerangTimeoutException[W <: Weight](elapsed: Long, stats: IBoomerangStats[W]) extends RuntimeException {

  override def toString: String = s"Boomerang timeout after $elapsed ms\n$stats"
}
