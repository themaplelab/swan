...
abstract class ControlFlowEdgeBasedFieldTransitionListener[W <: Weight](val cfgEdge: ControlFlowGraph.Edge) extends WPAUpdateListener[Field, INode[Node[ControlFlowGraph .Edge , Val]], W ] {
