...
class StoreIDEALResultHandler[W <: Weight] extends IDEALResultHandler[W] {
  ...
  protected val seedToSolver: mutable.HashMap[WeightedForwardQuery[W], ForwardBoomerangResults[W]] = mutable.HashMap.empty

  def getResults: mutable.HashMap[WeightedForwardQuery[W], ForwardBoomerangResults[W]] = seedToSolver

  override def report(seed: WeightedForwardQuery[W], res: ForwardBoomerangResults[W]): Unit = {
