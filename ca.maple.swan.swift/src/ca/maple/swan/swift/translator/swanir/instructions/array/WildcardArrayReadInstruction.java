//===--- WilcardArrayReadInstruction.java --------------------------------===//
//
...
public class WildcardArrayReadInstruction extends SWANIRInstruction {
    ...
    public WildcardArrayReadInstruction(String resultName, String resultType, String operand, InstructionContext ic) {
        super(ic);
    ...
    public void visit(ISWANIRVisitor v) {
        v.visitWildcardArrayReadInstruction(this);
    }

    @Override
    public String toString() {
        return result.simpleName() + " := " + operandBase.simpleName() + "[*]" + this.getComment();
    }
}